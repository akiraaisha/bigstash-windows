========================================================================
    ACTIVE TEMPLATE LIBRARY : BigStashExt Project Overview
========================================================================

AppWizard has created this BigStashExt project for you to use as the starting point for
...
BigStashExt.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (BigStashExt.h)
        GUID definitions                                (BigStashExt_i.c)
        A type library                                  (BigStashExt.tlb)
        Marshaling code                                 (BigStashExt_p.c and dlldata.c)

BigStashExt.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in BigStashExt.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named BigStashExt.pch and a precompiled types file named StdAfx.obj.
...
BigStashExtps.vcxproj
	...
	dlldata.c, BigStashExt_i.c and BigStashExt_p.c which are required
	to build the proxy/stub DLL.

BigStashExtps.vcxproj.filters
